...
// ---------- BOOKINGS ----------
export const BookingsScreen = ({ go, bookings }) => {
...
// ---------- GUEST FOLIO ----------
export const FolioScreen = ({ go, user, bookings }) => {
...
export const ExperienceScreen = ({ go }) => <ListPage eyebrow="Experiences" title={<>Curated days, <span className="tt-italic-soft" style={{ color: 'var(--accent)' }}>locally led.</span></>} sub="Pottery in Pondicherry. Yoga Near Auroville." items={[
