...
// ---------- BOOKING WIZARD ----------
export const BookingWizard = ({ go, ctx, onSubmit }) => {
  ...
  const next = () => {
    ...
    window.open(`https://wa.me/0000000000?text=${encodeURIComponent(msg)}`, '_blank', 'noopener,noreferrer');
    onSubmit(ctx2);
  };
...
export const WhatsAppSentScreen = ({ go, booking }) => (
