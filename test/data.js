...
window.WA_URL = 'https://api.whatsapp.com/send/?phone=0000000000&text=Hi%2C+I%27d+like+to+chat+about+Temple+And+Towns+Resorts.&type=phone_number&app_absent=0';
...
window.TT_DATA = {
  ...
  rooms: {
    ...
    p4: [
      { id: 'r4a', type: 'Nature Retreat', capacity: 2, price: 'Request to book', beds: '1 Queen', size: 'Attached Pool', amenities: ['WiFi', 'Garden View', 'Pool Access'] },
    ],
  },
  reviews: [
